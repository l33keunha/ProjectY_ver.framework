    ...
    <body>
     ...
     <div class="selectbox">
        ...
        <div class ="cell6">
            ...
            <div class="cell6_01">
                <div>
                <label><input type="checkbox" name="" value=""> 전체</label>
                <label><input type="checkbox" name="" value=""> 일반</label>
                <label><input type="checkbox" name="" value=""> 어린이</label>
                <label><input type="checkbox" name="" value=""> 청소년</label>
                <label><input type="checkbox" name="" value=""> 경로</label>
                <label><input type="checkbox" name="" value=""> 장애인</label>
                <label><input type="checkbox" name="" value=""> 국가유공자</label>
                <label><input type="checkbox" name="" value=""> 다자녀부모</label>
                <label><input type="checkbox" name="" value=""> 동반</label>
                <label><input type="checkbox" name="" value=""> 대학생</label>
                <label><input type="checkbox" name="" value=""> 복지</label>
                <label><input type="checkbox" name="" value=""> 기타</label>
                </div>
            </div>
        </div>
        <div class ="cell7">
            ...
            <div class="cell7_01">
                <div>
                <label><input type="checkbox" name="" value="00"> 전체</label>
                <label><input type="checkbox" name="" value="B"> 버스</label>
                <label><input type="checkbox" name="" value="T"> 지하철</label>
                </div>
            </div>
        </div>
        <div class ="cell8">
