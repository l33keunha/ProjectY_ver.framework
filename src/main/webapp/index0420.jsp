...
<html lang="ko">
	...
	window.onload = function(){
		$("input[name=passType]").attr("disabled", true);
	    $(".cell2_01").css("opacity", 0.3);
	    $(".cell2_02").css("opacity", 0.3);
	    $(".cell3").css("opacity", 0.3);
		$(".cell4").css("opacity", 0.3); 
		$("input[name=passTime]").attr("disabled", true);
		$("select[name=passTimeStart]").attr("disabled", true);
		$("select[name=passTimeEnd]").attr("disabled", true);
		$(".cell5").css("opacity", 0.3);
		$("input[name=passUserType]").attr("disabled", true);
		$(".cell6").css("opacity", 0.3);
		$("input[name=passTransport]").attr("disabled", true);
	...
	$('input[id=buttonTest]').on('click', function () {
		...
		var pushArray = [
					[ "passDateStart", 	$("input[name=passDateStart]").val()],
					[ "passDateEnd", 	$("input[name=passDateEnd]").val()],
					[ "passOwner", 		$("input[name=passOwner]:checked").val()],
					[ "passSido",  		$("select[name=passSido]").val()],
					[ "passSigungu", 	$("select[name=passSigungu]").val()],
					[ "passGroup", 		$("input[name=passGroup]:checked").val()],
					[ "passType", 		$("input[name=passType]:checked").val()],
					[ "passTime", 	    $("input[name=passTime]").val()],
					[ "passTimeStart", 	$("select[name=passTimeStart]").val()],
					[ "passTimeEnd", 	$("select[name=passTimeEnd]").val()]
		]
	...
	$(document).ready(function(){
		...
		$('.cell1').change(function(){
			if($("input[name=passGroup]:checked").val()=='passCnt'){
				$(".cell2_01").css("opacity", 1);
				$('.cell2_01').find('input').prop("disabled",false);
				$('.cell2_01').find('label').css("opacity",1);
				$('.cell2_01').change(function(){
					disabledTrue()
					if($("input[name=passType]:checked").val()=='passCnt_station'){
						disabledTime()
					}
				})
			} else if($("input[name=passGroup]:checked").val()=='passRouteODCnt'){
				disabledTrue()
				$('.cell6').css("opacity", 1);
			...
			} else if($("input[name=passGroup]:checked").val()=='passAreaODCnt'){
			...
			} else if($("input[name=passGroup]:checked").val()=='passTopRotue' || 'passTopStation'){
				disabledTrue()
				disabledTime()
			}
		});
	...
	function disabledTrue(){
		$(".cell3").css("opacity", 1);
		$(".cell4").css("opacity", 1); 
		$("input[name=passTime]").prop("disabled", false);
		$("select[name=passTimeStart]").prop("disabled", false);
		$("select[name=passTimeEnd]").prop("disabled", false);
		$(".cell5").css("opacity", 1);
		$("input[name=passUserType]").prop("disabled", false);
	...
	function disabledTime(){
		$(".cell4").css("opacity", 0.3); 
		$("input[name=passTime]").prop("disabled", true);
		$("select[name=passTimeStart]").prop("disabled", true);
		$("select[name=passTimeEnd]").prop("disabled", true);
	}
