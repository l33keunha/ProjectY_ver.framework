               ...
               if(data.searchStatusList[0].status == 'N'){
                  ...
                  if(provider == '03') {
                     ...
                     if(analType == "정류장별_통행"){
						...
						if(provider == '00'){
	                        addHtml += ", 복지_승차, 복지_하차, 복지_환승, 기타_승차, 기타_하차, 기타_환승";
						}
						addHtml += "</td>";
                     } else if(analType == "정류장간_목적통행" || analType == "정류장간_수단통행"){
                        addHtml += "<td>분석지역광역도, 분석지역시군, 분석자료, 분석일자, 승차내외부, 승차역ID, 승차지역명, 하차내외부, 하차역ID";
                        addHtml += "하차지역명, 시간, 일반, 어린이, 청소년, 경로, 장애인, 국가유공자, 다자녀부모, 동반, 대학생";
						if(provider == '00'){
							addHtml += ", 복지, 기타";
						}
						addHtml += "</td>";
                        ...
                        addHtml += "동반_승차, 동반_하차, 동반_환승, 대학생_승차, 대학생_하차, 대학생_환승";
						if(provider == '00'){
	                        addHtml += ", 복지_승차, 복지_하차, 복지_환승, 기타_승차, 기타_하차, 기타_환승";
						}
						addHtml += "</td>";
                        ...
                        addHtml += "<td>분석지역광역도, 분석지역시군, 분석자료, 분석일자, 출발존, 출발행정동, 도착존, 도착행정동, 시간, 일반,";
                        addHtml += "어린이, 청소년, 경로, 장애인, 국가유공자, 다자녀부모, 동반, 대학생";
						if(provider == '00'){
							addHtml += ", 복지, 기타";
						}
						addHtml += "</td>";
