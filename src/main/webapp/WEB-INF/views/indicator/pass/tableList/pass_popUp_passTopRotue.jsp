				...
				<table style="border-collapse: collapse;">
					...
					<thead>
						 <tr>
							...
							<th class="tg-0pky" rowspan="2" style="width: 180px; min-width: 180px; max-width: 180px;">노선명</th>			<!-- 노선명 -->
							<th class="tg-0pky" rowspan="2" style="width: 80px; min-width: 80px; max-width: 80px;">노선유형</th>			<!-- 노선유형 -->
							<th class="tg-0pky" rowspan="2" style="width: 180px; min-width: 180px; max-width: 180px;">기점</th>				<!-- 기점 -->
							<th class="tg-0pky" rowspan="2" style="width: 180px; min-width: 180px; max-width: 180px;">종점</th>				<!-- 종점 -->
						</tr>
					</thead>
					<!--thead 끝▲-->
					...
					<tbody>
						...
						<c:forEach var='j' begin='0' end='${forCnt-1}'>
							<tr>
								...
								<td class="tg-0pky" style="width: 30px; min-width: 30px; max-width: 30px;"><div class="lavel-2 lavel-1">${passResultList[j * columnCnt].r}</div></td>							<!-- 순위 -->
								<td class="tg-0pky" style="width: 180px; min-width: 180px; max-width: 180px;"><div class="lavel-2 lavel-1">${passResultList[j * columnCnt].routeNma}</div></td>					<!-- 노선명 -->
								<td class="tg-0pky" style="width: 80px; min-width: 80px; max-width: 80px;"><div class="lavel-2 lavel-1">${passResultList[j * columnCnt].routeType}</div></td>					<!-- 노선유형 -->
								<td class="tg-0pky" style="width: 180px; min-width: 180px; max-width: 180px;"><div class="lavel-2 lavel-1">${passResultList[j * columnCnt].routeStart}</div></td>					<!-- 기점 -->
								<td class="tg-0pky" style="width: 180px; min-width: 180px; max-width: 180px;"><div class="lavel-2 lavel-1">${passResultList[j * columnCnt].routeEnd}</div></td>					<!-- 종점 -->
							</tr>
						...
						<c:forEach var='j' begin='0' end='${forCnt-1}'>
							<tr>
		                        ...
		                        <c:forEach var='i' begin='${st}' end='${ed-1}' >
		                              ...
		                              <td class="tg-0pky" style="width: ${tdSize}px; min-width: ${tdSize}px; max-width: ${tdSize}px;"><fmt:formatNumber type="number" value="${passResultList[i].routeBusGinAgg}"/></td>      <!-- 이용자 유형 (승차) -->
		                              <td class="tg-0pky" style="width: ${tdSize}px; min-width: ${tdSize}px; max-width: ${tdSize}px;"><fmt:formatNumber type="number" value="${passResultList[i].routeBusGffAgg}"/></td>      <!-- 이용자 유형 (하차) -->
		                              <td class="tg-0pky" style="width: ${tdSize}px; min-width: ${tdSize}px; max-width: ${tdSize}px;"><fmt:formatNumber type="number" value="${passResultList[i].routeBusTrsAgg}"/></td>      <!-- 이용자 유형 (환승) -->
		                        	  <c:if test="${i == (ed-1)}">
										   <td class="tg-0pky" style="width: 100px; min-width: 100px; max-width: 100px;"><fmt:formatNumber type="number" value="${passResultList[i].routeBusSum}"/></td>	<!-- 합계(승차+하차) -->
									  </c:if>
		                        </c:forEach>      
