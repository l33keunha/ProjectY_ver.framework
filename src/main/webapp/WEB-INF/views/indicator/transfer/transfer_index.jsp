...
<html lang="ko">
    <head>
        ...
        <script type="text/javascript" src="resources/js/indicator/common_index.js" defer ></script> 
 		<script type="text/javascript" src="resources/js/indicator/transfer_index.js" defer ></script>
    ...
    <div class="ConEx" style="background:#fff url(resources/images/indicator/transferB.jpg)"></div>
        ...
        <div class="selectbox">
            <div class ="cell1" >
                ...
                <div class="cell1_01"> 
                    <div>
                        <label><input type="radio" name="anal_group" value="transferCnt"> 환승통행</label>
                    </div>
                </div>

                <div class="cell1_02">
                    <div>
                        <label><input type="radio" name="anal_group" value="transferTime"> 환승통행시간</label>
                    </div>
                </div>
            ...
            <div class ="cell2">
                ...
                <div class="cell2_01">
                    <div>
                        <label><input type="radio" name="anal_type" value="transferCnt_method"> 수단별통행</label>
                        <label><input type="radio" name="anal_type" value="transferCnt_station"> 정류장별통행</label>
                        <label><input type="radio" name="anal_type" value="transferCnt_route"> 노선별통행</label>
                        <label><input type="radio" name="anal_type" value="transferCnt_num"> 횟수별통행</label>
                    </div>
                </div>
                <div class="cell2_02">
                    <div>
                        <label><input type="radio" name="anal_type" value="transferTime_method"> 수단별 환승통행시간</label>
                        <label><input type="radio" name="anal_type" value="transferTime_num"> 횟수별 환승통행시간</label>
                    </div>
                </div>
        ...
        <input class="submit" type="button" id="transferBtn" value="조회" >
