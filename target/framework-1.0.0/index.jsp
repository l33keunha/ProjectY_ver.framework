        ...
        <div class ="cell6">
            ...
            <div class="cell6_01">
                <select name="passUserType">
                    ...
                    <option value="02" >어린이</option>
                    <option value="03" >청소년</option>
                    <option value="04" >경로</option>
                    <option value="05" >장애인</option>
                    <option value="06" >국가유공자</option>
                    <option value="07" >다자녀부모</option>
                    <option value="08" >동반</option>
                    <option value="09" >대학생</option>
                    <option value="10" >복지</option>
